            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-prslist ng-fault ng-container">
                        <ul>
                            <li v-for="(item,index) in shipinList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jumpCheck('../shipin/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" >
                                        <a href="#" class="ng-prsliik">
                                            <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                                <img class="swiper-item" :src="item.shipinPhoto?item.shipinPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                            </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jumpCheck('../shipin/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" ><span>{{item.shipinName}}</span></div>
